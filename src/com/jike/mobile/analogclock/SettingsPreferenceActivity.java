			...
			public boolean onPreferenceChange(Preference preference,
				...
				case 0:
					...
					try {
			        	 ...
			        	 String title = myCursor.getString(myCursor.getColumnIndex(MediaStore.Audio.Media.TITLE));
				...
				return SettingsPreferenceActivity.this.onPreferenceChange(preference, newValue);
			}
		});
		...
		if (requestCode == SONG_CODE) {
			...
			if (resultCode == RESULT_CANCELED) {
					...
					try {
			        	 myCursor = getContentResolver().query(uri,null,null,null,null);
			        	 myCursor.moveToFirst();
			        	 title = myCursor.getString(myCursor.getColumnIndex(MediaStore.Audio.Media.TITLE));
			        	 mSongPreference.setSummary(title);
			        	 savaAlarm();
					} catch (Exception e) {
						// TODO: handle exception
...
//		mAmPmPref.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
//			@Override
//			public boolean onPreferenceChange(Preference preference, Object newValue) {
//				// TODO Auto-generated method stub
...
//        mAlertSoundPref = (AlertSoundPreference) findPreference("alertSounds");
//        mAlertSoundPref.setOnPreferenceChangeListener(this);
//        mAlertSoundPref.setSoundPrefSummary(mAlarm.soundId);
		...
		mSnoozeDurationListPref
				.setSummary(mAlarm.snoozeInterval == 0 ? getString(R.string.never)
						: mAlarm.snoozeInterval + getString(R.string.min));
		mSnoozeDurationListPref.setValue(Integer
				.toString(mAlarm.snoozeInterval));// Integer.toString(mAlarm.snoozeInterval)
		mSnoozeDurationListPref
				.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
					public boolean onPreferenceChange(Preference p,
							Object newValue) {
						...
						val = val.equals("0") ? getString(R.string.never) : val + getString(R.string.min);
						p.setSummary(val);
...
//		 values.put(Alarm.Columns.DAYS_OF_WEEK, mRepeatPref.getDaysOfWeek().getCoded());
