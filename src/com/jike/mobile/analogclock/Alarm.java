...
//    add2010-10-31 16:53:31
	...
	public static class Columns implements BaseColumns {
        ...
        public static final Uri CONTENT_URI =
                Uri.parse("content://com.jike.mobile.analogclock/alarm");
     ...
     // Used when filtering OnSnooze alarms.
        ...
        static final String[] ALARM_QUERY_COLUMNS = {
            ...
            ENABLED, VIBRATE, MESSAGE, FADE_IN_LENGTH,SNOOZE_INTERVAL,VOLUME,SOUND_ID,IS_ON_SNOOZE,SOUND_TYPE,MUSIC_URI,TITLE,ALERT };
	...
	public Alarm(Cursor c) {
        ...
        // default alert.
        if (musicUri == null) {
        	musicUri = RingtoneManager.getDefaultUri(
...
//            Ĭ      
    ...
    public static final class DaysOfWeek {
        ...
        public String toString(Context context, boolean showNever) {
            ...
            if (mDays == 0) {
                return showNever ?
                        context.getText(R.string.never_repeat).toString() : "";
            }
